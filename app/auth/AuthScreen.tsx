...
import {
  ...
  KeyboardAvoidingView, Keyboard, Platform, TouchableWithoutFeedback, Image, StyleSheet
} from 'react-native';
...
export default function AuthScreen() {
  ...
  const signUp = async () => {
    ...
    try {
      ...
      const randomPlant = plantSeeds[Math.floor(Math.random() * plantSeeds.length)];
  ...
  return (
    <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
      <View style={styles.container}>
        <KeyboardAvoidingView behavior={Platform.OS === 'ios' ? 'padding' : 'position'} keyboardVerticalOffset={80}>
          <View style={styles.logoContainer}>
            <Image source={require('../../assets/images/clover-96.png')} style={styles.logoImage} resizeMode="contain" />
